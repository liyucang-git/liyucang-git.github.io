...
举一反三：如果面试题要求**处理一颗二叉树的遍历序列，则可以先找到二叉树的根结点，再基于根结点把整棵树的遍历序列拆分成左子树对应的子序列和右子树对应的子序列，接下来再递归处理这两个子序列**。
...
![](/img/localBlog/1582535347402.jpg)
...
![](/img/localBlog/1582550415145.jpg)
